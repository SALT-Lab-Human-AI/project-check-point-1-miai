...
**STAR Framework Confidence:**
Participants' self-rated confidence in applying the STAR framework improved significantly from pre-study (M = 2.8, SD = 1.2) to post-study (M = 4.1, SD = 0.8), representing a mean improvement of **+1.3 points** (t(9) = 3.1, p < .05, Cohen's d = 1.15).

*Table 2: Learning Gains by Experience Level*

| Experience              | N | Pre-Mean | Post-Mean | Gain       | % Increase   |
|-------------------------|---|----------|-----------|------------|--------------|
| **Novice (0-3)**        | 4 | 1.75     | 4.5       | **+2.75**  | +157%        |
...
The significant confidence improvement (+1.3 points overall, +2.75 for novices) demonstrates that structured, specific feedback effectively builds both competence and confidence in applying the STAR framework.
...
The **+2.75 point gain** for novices versus +0.0 for experts reveals an important design consideration: Mocksy is optimized for *learning* the STAR framework, not *perfecting* already-expert answers. This suggests a tiered product strategy:
...
1.  How many technical/behavioral interviews have you completed in the past?
    ...
    *   [ ] 4-10
    *   [ ] 10+
2.  How confident are you in your ability to structure behavioral interview answers using the STAR framework? (1-5 Scale)
...
12. After reviewing feedback, rate your confidence in applying the STAR framework (1-5).
13. Which part of the feedback was MOST useful? (Select One)
14. How much do you trust the AI's evaluation? (1-5)
15. If you used Mocksy regularly for 1-2 months, how confident would you feel in behavioral interviews? (1-5)
